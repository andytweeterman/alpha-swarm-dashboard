...
def test_governance_calculation():
    ...
    assert reason in ["Structural Failure Confirmed", "Extreme Volatility", "Credit/Currency Stress", "Elevated Volatility", "Market Breadth Narrowing", "System Integrity Nominal", "Initializing...", "Feed Disconnected"]
