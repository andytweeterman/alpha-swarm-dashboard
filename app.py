...
def get_strategist_update(filepath="update.csv"):
    try:
        update_df = pd.read_csv(filepath)
        ...
        return up_date, up_title, up_text

    except Exception:
        return "System Status", "Data Feed Offline", "Strategist update pending."
...
try:
    ...
    up_date, up_title, up_text = get_strategist_update()
